	...
	<div class="ads-grid">
		<div class="container">
			...
			<div class="side-bar col-md-3">
				...
				<!-- food preference -->
				<div class="left-side">
					<h3 class="agileits-sear-head">Thực phẩm ưu tiên</h3>
					<ul>
						<li>
				...
				<div class="left-side">
					...
					<ul>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Bến Tre</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Tiền Giang</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Trà Vinh</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Vĩnh Long</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">An Giang</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Cần Thơ</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Hậu Giang</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Cà Mau</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Kiên Giang</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span"> Đồng Tháp </span>
						</li>
					</ul>
				</div>
				<!-- //cuisine -->
			...
			<div class="agileinfo-ads-display col-md-9">
				<div class="wrapper">
					...
					<div class="product-sec1">
						<h3 class="heading-tittle">Đậu phộng</h3>
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Quả hạnh nhân, 100g</a>
									</h4>
					...
					<div class="product-sec1 product-sec2">
						<div class="col-xs-7 effect-bg">
							<h3 class="">Năng lượng thuân khiêt</h3>
							<h6>Thưởng thức tất cả các sản phẩm tốt cho sức khỏe của chúng tôi</h6>
							<p>Nhận thêm 10% Off</p>
						</div>
						<h3 class="w3l-nut-middle">Các loại hạt và trái cây khô</h3>
					...
					<div class="product-sec1">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Dầu thiên nhiên, 1L</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html"> Dầu Fortune, 5L</a>
									</h4>
									<div class="info-product-price">
					...
					<div class="product-sec1">
						<h3 class="heading-tittle">Mì ống và mì</h3>
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html"> Phở Yippee, 65g</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Mì ống, 500g</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Hủ tiếu Nam vang, 68g</a>
									</h4>
									<div class="info-product-price">
				...
				<ul id="flexiselDemo1">
					...
					<li>
						<div class="w3l-specilamk">
							...
							<div class="product-name-w3l">
								<h4>
									<a href="single.html">Cà chua Kissan, 950g</a>
								</h4>
								<div class="w3l-pricehkj">
									<h6>99.00</h6>
									<p>Giảm còn 20.00</p>
					...
					<li>
						<div class="w3l-specilamk">
							...
							<div class="product-name-w3l">
								<h4>
									<a href="single.html">Đường tinh khiết Madhur, 1g</a>
								</h4>
								<div class="w3l-pricehkj">
									<h6>69.00</h6>
									<p>Giảm giá 20.00</p>
