	...
	<div class="banner-bootom-w3-agileits">
		<div class="container">
			...
			<div class="col-md-7 single-right-left simpleCart_shelfItem">
				<h3>Gạo Basmati cao cấp Zeeba - 5 KG</h3>
				<div class="rating1">
				...
				<div class="single-infoagile">
					<ul>
						...
						<li>
						Được bán và hoàn thành bởi Supple Tek (3.6 trên 5 | 8 xếp hạng).
						</li>
						<li>
						1 lời đề nghị từ
							<span class="item_price">950.00</span>
				...
				<div class="product-single-w3l">
					<p>
						...
						<label>Ăn chay</label> sản phẩm.</p>
					<ul>
						<li>
						Tốt nhất cho Biryani và Pulao.
						</li>
						<li>
						Sau khi nấu, hạt gạo Zeeba Basmati đạt được chiều dài thông thường lên tới 2,4 cm / ~ 1 inch.
						</li>
						<li>
						Gạo Zeeba Basmati tuân thủ các tiêu chuẩn an toàn thực phẩm cao nhất vì sức khỏe của bạn là tối quan trọng đối với chúng tôi.
						</li>
						<li>
						Chỉ chứa loại gạo basmati tốt nhất và tinh khiết nhất có chất lượng Xuất khẩu.
						</li>
					</ul>
					<p>
						<i class="fa fa-refresh" aria-hidden="true"></i>Tất cả các sản phẩm thực phẩm là
						<label>không thể hoàn trả.</label>
					</p>
				</div>
				...
				<ul id="flexiselDemo1">
					...
					<li>
						<div class="w3l-specilamk">
							...
							<div class="product-name-w3l">
								<h4>
									<a href="single.php">Cà chua Kissan, 950g</a>
								</h4>
								<div class="w3l-pricehkj">
									<h6>99.00</h6>
									<p>Giảm còn 20.00</p>
