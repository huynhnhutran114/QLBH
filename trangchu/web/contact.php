...
<body>
				...
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
						<form action="#" method="post">
							...
							<div class="">
								<input class="text" type="text" name="subject" placeholder="Vấn đề" required="">
							</div>
							<div class="">
								<input class="email" type="email" name="email" placeholder="Email" required="">
							</div>
							<div class="">
								<textarea placeholder="Ghi chú" name="message" required=""></textarea>
							</div>
					...
					<div class="contact-right wthree">
						<div class="col-xs-7 contact-text w3-agileits">
							<h4>Địa chỉ:</h4>
							<p>
								<i class="fa fa-map-marker"></i> 123 đường Nguyễn Đức Thuận, Hiệp Thành, TDM, Bình Dương</p>
							<p>
								<i class="fa fa-phone"></i> Telephone : 0399686262</p>
							<p>
								<i class="fa fa-fax"></i> FAX : +1 888 888 4444</p>
							<p>
								<i class="fa fa-envelope-o"></i> Email :
								<a href="mailto:example@mail.com">huynhnhutran114@gmail.com</a>
							</p>
						</div>
	...
	<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3916.4689152848437!2d106.6670216141734!3d11.003401657973424!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3174d1041e3c436d%3A0xcf902f537676977a!2zxJDGsOG7nW5nIFPhu5EgMSwgSGnhu4dwIFRow6BuaCwgVGjhu6cgROG6p3UgTeG7mXQsIELDrG5oIETGsMahbmcsIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1595302495090!5m2!1svi!2s" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
	</div>
	<!-- //map -->
	<!-- newsletter -->
